import { bochtMaterial } from './materials.js';
...
function addBocht(name, points) {
  ...
  spline.initFromArray([
    ...
    [points[2][0], 0, -points[2][1]],
    [points[3][0], 0, -points[3][1]],
  ]);
  spline.reparametrizeByArcLength(10);
  bocht.vertices.push(middle);
  for (var i = 0; i < spline.points.length; i++) {
    bocht.vertices.push(
      new THREE.Vector3(spline.points[i].x, 0, spline.points[i].z)
    );
...
export function addBochten() {
  addBocht('Witvenstraat', [
    [152463.24, 221884.96],
    [152466.98, 221879.49],
    [152466.44, 221884.96],
    [152468.71, 221887.76],
  ...
  addBocht('Platanenlaan Palmenlaan', [
    [152616.17, 222188.06],
    [152613.51, 222192.2],
    [152617.24, 222190.06],
    [152621.77, 222190.73],
  ...
  addBocht('Platanenlaan Wilgenlaan', [
    [152656.0, 222115.77],
    [152651.6, 222113.01],
    [152653.75, 222116.64],
    [152653.24, 222120.44],
  ...
  addBocht('Berkenlaan Wilgenlaan', [
    [152591.82, 222071.49],
    [152587.95, 222077.24],
    [152592.52, 222074.56],
    [152598.13, 222075.67],
  ...
  addBocht('Berkenlaan Witvenstraat', [
    [152644.79, 221987.4],
    [152636.85, 221982.29],
    [152640.99, 221988.83],
    [152639.47, 221996.22],
